...
IFontDisp = Font
__all__ = [ 'FONTBOLD', 'OLE_TRISTATE', 'Checked', 'OLE_XSIZE_PIXELS',
           'OLE_HANDLE', 'IFont', 'VgaColor', 'OLE_XPOS_HIMETRIC',
           'Picture', 'IPictureDisp', 'OLE_YPOS_PIXELS',
           'FONTSTRIKETHROUGH', 'StdFont', 'OLE_XPOS_CONTAINER',
           'FontEvents', 'OLE_XSIZE_HIMETRIC', 'OLE_COLOR',
           'OLE_OPTEXCLUSIVE', 'Color', 'IFontEventsDisp', 'Default',
           'Font', 'OLE_ENABLEDEFAULTBOOL', 'Monochrome', 'IPicture',
           'OLE_YSIZE_PIXELS', 'StdPicture', 'OLE_XPOS_PIXELS',
           'IFontDisp', 'OLE_YSIZE_HIMETRIC', 'OLE_CANCELBOOL',
           'OLE_YPOS_CONTAINER', 'FONTUNDERSCORE',
           'LoadPictureConstants', 'FONTSIZE', 'FONTITALIC',
           'FONTNAME', 'OLE_YSIZE_CONTAINER', 'Gray', 'Unchecked',
