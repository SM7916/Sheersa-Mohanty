...
public class DownloadLetterExtractFileFromServer {
		...
		try {
			...
			if (FTPDetails.contains("#")) {
				...
				try {
					...
					String fileNameformat = "i8020a_pmrg_%s(\\d{6})_%s_\\d{2}.dat";
					fileNamePattern = String.format(fileNameformat, BBDate, BatchNumber);
