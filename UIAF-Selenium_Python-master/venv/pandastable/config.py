...
baseoptions['base'] = {'font': 'IBMPlexSans','fontsize':9, 'fontstyle':'',
                        'floatprecision':2,
...
class preferencesDialog(Frame):
    ...
    def createWidgets(self):
        ...
        self.opts = {'rowheight':{'type':'scale','default':18,'range':(5,50),'interval':1,'label':'row height'},
                ...
                'font':{'type':'combobox','default':'IBMPlexSans','items':fonts},
                'fontstyle':{'type':'combobox','default':'','items':['','bold','italic']},
                'fontsize':{'type':'scale','default':9,'range':(5,40),'interval':1,'label':'font size'},
