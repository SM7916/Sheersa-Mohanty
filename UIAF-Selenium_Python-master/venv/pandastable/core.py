...
class Table(Canvas):
    ...
    def tableChanged(self):
        ...
        self.update_var()
        return
    def update_var(self,value=None):
        global update
        ...
        if hasattr(self, 'cellentry'):
          ...
          if self.flag ==0:
            ...
            if self.filtered == 1:
                ...
                df = None
            self.model.setValueAt(value, self.endrow, self.endcol, df=df)


            self.drawText(self.endrow, self.endcol, value, align=self.align)
            self.model.setValueAt(value, self.endrow, self.endcol, df=df)
            self.update_var()
            self.delete('entry')
            self.cellentry.destroy()
    ...
    def popupMenu(self, event, rows=None, cols=None, outside=None):
        ...
        filecommands = ['Open','Save','Save As']
    ...
    def drawRect(self, row, col, color=None, tag=None, delete=1):
        ...
        self.lower(recttag)
        return
    def handleCellEntry1(self, row, col):
    ...
    def load(self, filename=None):
        ...
        if filename == None:
            ...
            filename=filedialog.askopenfilename(parent=self.master,filetypes=[("xlsx","*.xlsx")])
